      ...
      if (!response.ok) {
        ...
        if (response.status === 409) {
          ...
          try {
            ...
            console.log("[Profile iOS] 409 doublon — membre existant:", dupNumber, dupName);
          } catch {
            console.log("[Profile iOS] 409 — impossible de parser la réponse");
          }
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.duplicateSheet}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.85}
              onPress={() => {
                console.log("[Profile iOS] Modal 409 — 'Voir ma carte' appuyé, member_number:", duplicateMemberNumber);
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              onPress={() => {
                console.log("[Profile iOS] Modal 409 — 'Fermer' appuyé");
                setDuplicateModal(false);
              }}
            >
        ...
        >
          <View style={styles.pickerSheet}>
            ...
            {GENDER_OPTIONS.map((opt) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    console.log("[Profile iOS] Sexe sélectionné:", opt.label);
                    setGender(opt.value);
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                console.log("[Profile iOS] Picker sexe annulé");
                setGenderPickerVisible(false);
              }}
            >
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                console.log("[Profile iOS] Ouverture picker sexe");
