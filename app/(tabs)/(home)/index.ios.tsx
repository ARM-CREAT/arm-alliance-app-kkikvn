...
export default function HomeScreen() {
  ...
  useEffect(() => {
    const fetchMemberCount = async () => {
      console.log('[Home iOS] GET /api/member-profiles (member count)');
      try {
        const response = await fetch(`${BACKEND_URL}/api/member-profiles`);
        if (!response.ok) {
          const text = await response.text();
          console.warn('[Home iOS] Member count API error:', response.status, text);
          setMemberCount(0);
          return;
        }
        const data = await response.json();
        const count = Array.isArray(data) ? data.length : 0;
        console.log('[Home iOS] Member count:', count);
        setMemberCount(count);
      } catch (err) {
        console.warn('[Home iOS] Failed to fetch member count:', err);
        setMemberCount(0);
      }
    };
    fetchMemberCount();
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity
            onPress={() => {
              console.log('[Home iOS] Voir tout Programme appuyé');
              router.push('/program');
            }}
          >
          ...
          {displayedProgram.map((item, index) => {
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() => {
                  console.log('[Home iOS] Programme card appuyé:', item.title);
      ...
      <View style={styles.section}>
        ...
        <View style={styles.ideologyCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              console.log('[Home iOS] Découvrir notre idéologie appuyé');
      ...
      <View style={styles.section}>
        ...
        <View style={styles.supportCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              console.log('[Home iOS] Faire une contribution appuyé');
      ...
      <View style={styles.section}>
        ...
        <View style={styles.actionsGrid}>
          <TouchableOpacity
            ...
            onPress={() => {
              console.log('[Home iOS] Action Adhérer appuyée');
          ...
          <TouchableOpacity
            style={styles.actionCard}
            onPress={() => {
              console.log('[Home iOS] Action Ma Carte appuyée');
          ...
          <TouchableOpacity
            style={styles.actionCard}
            onPress={() => {
              console.log('[Home iOS] Action Admin appuyée');
              router.push('/admin');
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              console.log('[Home iOS] Action Notre Programme appuyée');
              router.push('/program');
            }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              console.log('[Home iOS] Action Adhérents appuyée');
          ...
          <TouchableOpacity
            style={[styles.actionCard, styles.actionCardGreenBg]}
            onPress={() => {
              console.log('[Home iOS] Action Guide des Partis appuyée');
              router.push('/ideology');
            }}
          >
