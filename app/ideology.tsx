        ...
        <View style={styles.section}>
          ...
          <View style={styles.speechCard}>
            <Text style={styles.speechTitle}>
              SUR L&apos;ALLIANCE DES ÉTATS DU SAHEL (AES)
            </Text>
            ...
            {/* Section 1: Vision de l'ARM sur l'AES */}
            <View style={styles.speechSection}>
              <View style={styles.speechSectionHeader}>
                ...
                />
                <Text style={styles.speechSectionTitle}>1. La vision de l&apos;ARM sur l&apos;AES</Text>
              </View>
              <Text style={styles.speechText}>
            ...
            <View style={styles.speechSection}>
              <View style={styles.speechSectionHeader}>
                <IconSymbol 
                  ...
                  color={colors.primary} 
                />
                <Text style={styles.speechSectionTitle}>2. L&apos;engagement clair de l&apos;ARM</Text>
              </View>
              <Text style={styles.speechText}>
            ...
            {/* Section 3: AES et développement économique */}
            <View style={styles.speechSection}>
              <View style={styles.speechSectionHeader}>
                <IconSymbol 
                  ...
                  color={colors.primary} 
                />
                <Text style={styles.speechSectionTitle}>3. AES et développement économique</Text>
              </View>
              <Text style={styles.speechText}>
            ...
            {/* Section 4: AES et gouvernance intègre */}
            <View style={styles.speechSection}>
              <View style={styles.speechSectionHeader}>
                <IconSymbol 
                  ...
                  color={colors.primary} 
                />
                <Text style={styles.speechSectionTitle}>4. AES et gouvernance intègre</Text>
              </View>
              <Text style={styles.speechText}>
                Chers compatriotes,
              </Text>
            ...
            <View style={styles.speechConclusion}>
              <Text style={styles.speechConclusionTitle}>Message aux peuples du Sahel</Text>
              <Text style={styles.speechConclusionText}>Notre destin est lié.</Text>
              <Text style={styles.speechConclusionText}>Nos combats sont communs.</Text>
              <Text style={styles.speechConclusionText}>Nos victoires seront partagées.</Text>
              <Text style={styles.speechText}>
              ...
              <Text style={styles.speechFinalStatement}>
...
const styles = StyleSheet.create({
  ...
  characteristicHeader: {
    flexDirection: 'row',
    alignItemsNow I'll add the presidential speech about the AES to the ideology screen. This is an important political statement that should be prominently displayed in the party's ideology section.

<write file="app/ideology.tsx">
import React from "react";
import { 
  StyleSheet, 
  View, 
